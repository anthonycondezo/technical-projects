import { KVMap, BaseRun } from "@langchain/core/node_modules/langsmith/schemas";
import { RunTree } from "@langchain/core/node_modules/langsmith/run_trees";
...
export declare abstract class BaseTracer extends BaseCallbackHandler {
    ...
    _addRunToRunMap(run: Run): {
        ...
        tags?: string[];
        attachments?: import("@langchain/core/node_modules/langsmith/schemas").Attachments;
    };
