# USART library
## Description
The USART library allows users to establish USART communication with the ATmega328p micro-controller: allowing stings to be send to and from the micro-controller.
